  ...
  <section class="py-5 text-center">
    <div class="container">
      ...
      <div class="d-flex flex-wrap justify-content-center mt-3">
        ...
        <a href="#" class="btn btn-outline-primary m-1">Majestic</a>
        <a href="#" class="btn btn-outline-primary m-1">Eternal</a>
        <a href="#" class="btn btn-outline-primary m-1">Vibrant</a>
        <a href="#" class="btn btn-outline-primary m-1">Picturesque</a>
        <a href="#" class="btn btn-outline-primary m-1">Flourishing</a>
      </div>
    </div>
  </section>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
              <img src="northen.jpg" class="card-img-top" alt="Northern Lights">
              <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card shadow-sm">
            <img src="falls.jpg" class="card-img-top" alt="Falls">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card shadow-sm">
            <img src="flight.jpg" class="card-img-top" alt="Flight">
            <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
              <img src="mountain.jpg" class="card-img-top" alt="Mountain">
              <div class="card-body">
...
## OUTPUT:
![alt text](<Screenshot 2024-12-25 153223.png>)
![alt text](<Screenshot 2024-12-25 153242.png>)
![alt text](<Screenshot 2024-12-25 153252.png>)
